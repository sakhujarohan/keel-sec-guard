...
export function writeRunArtifacts(outputDir, markdownReport, artifacts) {
    if (!outputDir)
        return;
    try {
        ...
        if (!fs.existsSync(gitignorePath)) {
            fs.writeFileSync(gitignorePath, `# Auto-generated by keel-sec-guard: Ignore all audit artifacts\n*\n`, 'utf-8');
        }
